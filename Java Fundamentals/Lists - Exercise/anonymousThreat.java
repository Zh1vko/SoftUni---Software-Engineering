    ...
    public static void main(String[] args) {
        ...
        while (!command.equals("3:1")) {
            ...
            if (command.contains("merge")) {
                ...
                String elementForDivide = texts.get(index);    // Взимаме елемента, който ще разделяме
                texts.remove(index);                           // Премахваме го от списъка

                int partSize = elementForDivide.length() / parts; // по колко букви в част ще имаме
