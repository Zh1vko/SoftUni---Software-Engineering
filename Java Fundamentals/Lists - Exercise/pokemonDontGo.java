...
public class pokemonDontGo {
    public static void main(String[] args) {
        ...
        while (numbers.size() > 0) {
            ...
            if (index >= 0 && index <= numbers.size()-1) {
                ...
                modifiedList(numbers, removedElement);
            }
                ...
                modifiedList(numbers, firstElement);
            }
                ...
                modifiedList(numbers, lastElement);
    ...
    private static void modifiedList(List<Integer> numbers, int removedElement) {
